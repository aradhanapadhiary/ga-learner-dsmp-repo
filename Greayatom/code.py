...
margin_of_error = z_critical * sample_std / sample_size**.5
...
#Code starts here
data['int.rate'] = data['int.rate'].map(lambda x: float(str(x)[:-1]))
